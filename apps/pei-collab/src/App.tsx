...
const DatabaseTestRunner = lazy(() =>
  import("./components/debug/DatabaseTestRunner").then((module) => ({
    default: module.DatabaseTestRunner || module.default,
  })),
);
const UsabilityTestingManager = lazy(() =>
  import("./components/debug/UsabilityTestingManager").then((module) => ({
    default: module.UsabilityTestingManager || module.default,
  })),
);
const NotificationManager = lazy(() =>
  import("./components/shared/NotificationManager").then((module) => ({
    default: module.NotificationManager || module.default,
  })),
);
