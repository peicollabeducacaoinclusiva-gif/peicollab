...
import { saveAuthToken } from "@pei/auth";
...
const Auth = () => {
  ...
  useEffect(() => {
    ...
    // THEN check if user is already logged in (verificar SSO primeiro)
    const checkSession = async () => {
      try {
        ...
        try {
          ...
          if (restoredSession) {
            console.log('✅ Sessão SSO restaurada com sucesso no Auth');
