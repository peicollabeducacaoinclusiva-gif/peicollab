...
-- Índices
CREATE INDEX IF NOT EXISTS "idx_pei_meetings_date" ON "public"."pei_meetings"("meeting_date");
CREATE INDEX IF NOT EXISTS "idx_pei_meetings_status" ON "public"."pei_meetings"("status");
CREATE INDEX IF NOT EXISTS "idx_pei_meetings_tenant" ON "public"."pei_meetings"("tenant_id");
CREATE INDEX IF NOT EXISTS "idx_pei_meetings_school" ON "public"."pei_meetings"("school_id");
CREATE INDEX IF NOT EXISTS "idx_pei_meetings_type" ON "public"."pei_meetings"("meeting_type");

-- ============================================================================
-- TABELA: pei_meeting_peis
-- ============================================================================
-- Vinculação entre reuniões e PEIs discutidos
CREATE TABLE IF NOT EXISTS "public"."pei_meeting_peis" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Índices
CREATE INDEX IF NOT EXISTS "idx_pei_meeting_peis_meeting" ON "public"."pei_meeting_peis"("meeting_id");
CREATE INDEX IF NOT EXISTS "idx_pei_meeting_peis_pei" ON "public"."pei_meeting_peis"("pei_id");
...
-- Índices
CREATE INDEX IF NOT EXISTS "idx_pei_meeting_participants_meeting" ON "public"."pei_meeting_participants"("meeting_id");
CREATE INDEX IF NOT EXISTS "idx_pei_meeting_participants_user" ON "public"."pei_meeting_participants"("user_id");
CREATE INDEX IF NOT EXISTS "idx_pei_meeting_participants_status" ON "public"."pei_meeting_participants"("presence_status");
