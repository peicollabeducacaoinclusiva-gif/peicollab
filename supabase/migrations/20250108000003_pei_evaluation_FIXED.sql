-- ============================================================================
-- MIGRAÇÃO CORRIGIDA: Avaliações Cíclicas do PEI
-- ============================================================================
-- Sistema completo de avaliações por ciclo (I, II, III)
-- Data: 2025-01-08
-- Versão: FIXED - Com DROP POLICY IF EXISTS
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS "public"."pei_evaluations" (
    ...
    -- Garantir uma avaliação por ciclo por ano
...
SELECT 'Migração 3 aplicada com sucesso! (FIXED)' AS status;
