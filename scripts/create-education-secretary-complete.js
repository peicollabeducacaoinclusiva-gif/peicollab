...
async function createEducationSecretaryComplete() {
  console.log('🏛️ Criando usuário completo do Secretário de Educação...\n');
  ...
  try {
    ...
    // 3. Criar o usuário na tabela auth.users usando RPC
    console.log('\n3. Criando usuário na tabela auth.users...');
    ...
    console.log('✅ Usuário criado na auth.users:', authUser);
...
createEducationSecretaryComplete();
