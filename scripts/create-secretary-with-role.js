...
async function createSecretaryWithRole() {
  console.log('🏛️ Criando Secretário de Educação (com role)...\n');
  ...
  try {
    ...
    // 4. Criar role na tabela user_roles também
    console.log('\n3. Criando role na tabela user_roles...');
    ...
    if (roleError) {
      console.log('⚠️ Erro ao criar role na user_roles:', roleError.message);
      console.log('💡 Isso é normal se a tabela user_roles não estiver funcionando');
    } else {
      console.log('✅ Role criado na user_roles:', insertedRole);
    }
