...
async function createSecretaryAuthFirst() {
  console.log('🏛️ Criando Secretário de Educação (auth primeiro)...\n');
  ...
  try {
    ...
    // 2. Criar usuário via auth primeiro
    console.log('\n2. Criando usuário via Supabase Auth...');
    ...
    // 4. Criar profile com role válido
    console.log('\n3. Criando profile do secretário...');
    const secretaryData = {
      id: secretaryId,
      full_name: 'Dr. Roberto Secretário de Educação',
      tenant_id: tenantId,
