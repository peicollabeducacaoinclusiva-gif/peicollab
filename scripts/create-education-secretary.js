...
async function createEducationSecretary() {
  console.log('🏛️ Criando usuário do Secretário de Educação...\n');
  ...
  try {
    ...
    // 3. Criar o usuário do secretário de educação
    console.log('\n3. Criando usuário do secretário de educação...');
    const secretaryId = '88888888-8888-8888-8888-888888888888';
    const secretaryData = {
      id: secretaryId,
    ...
    console.log('   2. Faça login com o ID: 88888888-8888-8888-8888-888888888888');
